module.exports = {
  title: 'Dynamic Text for Grafana',
  url: 'https://marcusolsson.github.io',
  baseUrl: '/grafana-dynamictext-panel/',
  onBrokenLinks: 'throw',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/favicon.svg',
  organizationName: 'marcusolsson', // Usually your GitHub org/user name.
  projectName: 'grafana-dynamictext-panel', // Usually your repo name.
  themeConfig: {
    navbar: {
      title: 'Dynamic Text for Grafana',
      logo: {
      ...
      items: [
        {
          href: 'https://github.com/marcusolsson/grafana-dynamictext-panel',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://grafana.com/plugins/marcusolsson-dynamictext-panel',
          label: 'Marketplace',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Discussions',
              href: 'https://github.com/marcusolsson/grafana-dynamictext-panel/discussions',
            },
            {
              label: 'Support',
              href: 'https://github.com/marcusolsson/grafana-dynamictext-panel/discussions/categories/q-a',
            },
            {
              label: 'Twitter',
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/marcusolsson/grafana-dynamictext-panel/edit/main/website/',
          routeBasePath: '/',
        },
        theme: {
